  ...
  return (
    <div className="relative">
      ...
      <div className="relative mx-auto text-center sm:px-6 lg:px-8">
        <div className="flex items-center justify-center pt-12 font-pixelated text-4xl font-bold tracking-widest text-foreground sm:text-6xl">
          <span>World</span>
        ...
        <p className="mx-auto my-8 max-w-3xl text-xl text-muted-foreground">
