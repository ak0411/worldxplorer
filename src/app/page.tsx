    ...
    <>
      <main className="bg-secondary">
        ...
        <div className="relative h-[200px]">
          ...
          <div className="absolute left-[25px] top-[75px] animate-pulse rounded-full bg-emerald-500 p-3 shadow-lg">
            <MapPin className="h-6 w-6 text-white" />
          </div>
          <div className="absolute left-[1825px] top-[125px] animate-pulse rounded-full bg-rose-500 p-3 shadow-lg">
